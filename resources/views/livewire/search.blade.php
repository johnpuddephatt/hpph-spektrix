<div class="" x-data="{ open: false }">
    ...
    <div class="text-black container fixed inset-0 left-auto z-50 flex h-screen w-full max-w-lg transform flex-col bg-sand p-12 transition-all delay-100 duration-200"
