 ...
 <div x-data="{ filtersOpen: false, viewOpen: false }">
     ...
     <div class="container relative z-[14] flex flex-row items-end justify-between gap-2 bg-sand pb-6 pt-32">
         @if (!$type === 'past')
     ...
     <div class="flex flex-col bg-sand lg:block">
         <div
             class="z-[11] flex-row-reverse justify-between border-b border-sand bg-sand-light transition lg:container before:absolute before:bottom-full before:left-0 before:right-0 before:-z-10 before:hidden before:h-[3.75rem] before:bg-sand lg:sticky lg:bottom-auto lg:top-[3.75rem] lg:flex lg:translate-y-0 lg:py-2.5 lg:pr-14 lg:before:block">
                                     ...
                                     <form class="px-8 py-16 md:px-16" method="dialog">
                                         <div class="mx-auto max-w-md">
                                             ...
                                             <button aria-label="Close strand filter" value="cancel"
                                                 ...
                                                 @svg('plus', 'rotate-45 w-9 h-9 p-2 mr-1 align-top rounded-full bg-black block')
                                                 Close
                                             </button>
                                         </div>
                                     </form>
                                 ...
                                 <form class="px-8 py-16 md:px-16" method="dialog">
                                     <div class="mx-auto max-w-md">
                                         ...
                                         <button aria-label="Close accessibility filter" value="cancel"
                                             class="type-xs-mono absolute left-1/2 top-full mt-4 flex -translate-x-1/2 flex-row items-center overflow-hidden rounded-full border border-black bg-black-light pr-4 !leading-none text-white transition hover:bg-black">
                                             @svg('plus', 'rotate-45 w-9 h-9 p-2 mr-1 rounded-full align-top bg-black block')
                                             Close
                                         </button>
                                     </div>
                                 </form>
                                 ...
                                 <form class="px-8 py-16 md:px-16" method="dialog">
                                     <div class="mx-auto max-w-md">
                                         ...
                                         <button aria-label="Close date filter" value="cancel"
                                             ...
                                             @svg('plus', 'rotate-45 w-9 h-9 p-2 align-top mr-1 rounded-full bg-black block')
                                             Close
                                         </button>
                                     </div>
                                 </form>
