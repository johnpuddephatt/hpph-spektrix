                ...
                <div class="gap-8 lg:flex-1 flex flex-col lg:flex-row lg:gap-12">
                    ...
                    <div x-show="instances && instances.length && instances.some((instance) => instance.event.audio_description || instance.captioned || instance.autism_friendly || instance.toddler_friendly)"
                        ...
                        <div x-show="instances.some((instance) => instance.special_event == 'Pay What You Can')"
                            ...
                            <p class="type-small mt-2 !font-normal">This screening allows you to choose the ticket price you’re able to afford. Those unable to pay can obtain free tickets 48hrs before the screening. <a target="_blank" href="https://hpph.co.uk/strands/hyde-seek#how-do-i-access-free-pay-what-you-can-tickets" class="underline">Learn more</a>.</p>
