@extends('layouts.default', ['header_colour' => 'light', 'header_position' => 'default', 'edit_link' => route('nova.pages.edit', ['resource' => 'strands', 'resourceId' => $strand->id])])
@section('title', $strand->name)
@section('content')
    <div class="fixed inset-0 -z-10 h-[calc(66.6vh-1rem)] w-full overflow-hidden bg-black">
    ...
    <div class="relative z-[-1] mt-[calc(66.6vh-4.25rem-1rem)]">
        ...
        <a href="#event-content"
            class="fixed left-1/2 top-[calc(66.6vh-4rem-1rem)] z-10 -translate-x-1/2 transform text-5xl text-white">@svg('down-chevron', 'h-16 w-16')</a>
