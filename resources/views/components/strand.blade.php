@if ($strand)
    <div class="group relative w-6 text-gray" style="color: {{ $strand->color }}">
        ...
        <div class="type-xs-mono absolute left-1/2 top-full translate-y-2 -translate-x-1/2 transform whitespace-nowrap rounded py-1 px-3 opacity-0 transition duration-500 group-hover:opacity-100"
