...
<div class="flex flex-row items-center gap-2">
    ...
    <span class="type-xs-mono px-2.5 py-1.5 h-7 text-center rounded-full bg-sand-light" x-show="instance.relaxed">R</span>
    <span class="type-xs-mono px-2 py-1.5 h-7 text-center rounded-full bg-sand-light"
        x-show="instance.event.audio_description">AD</span>
