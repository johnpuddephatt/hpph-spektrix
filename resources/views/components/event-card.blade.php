...
<div class="group border-gray-light relative md:pt-3 mb-4 pb-4 md:border-b flex flex-col px-2">
    ...
    <div class="max-md:container md:bg-transparent bg-sand-light pb-4">
        ...
        <div> <a class="type-small border:sand-light hover:text-sand-light hover:bg-gray-dark before:absolute before:inset-0 lg:border-sand-light inline-block py-0 bg-sand lg:bg-sand-light rounded-full px-2"
