<div x-cloak x-show="(instance.availability.seats / instance.availability.capacity) <= {{ nova_get_setting('availability_threshold', 0.15) }}"
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block py-1 opacity-50 w-4 mr-0.5 h-auto" data-name="Layer 1"
        viewBox="0 0 24 24">
    ...
    <span class="pt-0.5 leading-none" x-text="instance.availability.seats > 0  ? 'Last few' : 'Sold out'"></span>
    ...
    <div class="flex items-center"
        ...
        <span class="pt-0.5 leading-none" x-text="'×' + instance.availability.accessible_seats"></span>
    </div>
