...
@if($layout->display_images)
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex gap-2 mt-4 justify-center items-center">                    
                            ...
                            <button  style="color: @yield('color'); border-color: @yield('color')" class="text-black leading-none type-regular bg-transparent rounded  py-1 px-2.5" data-increment-quantity> + </button>
                        </div>
                        @endif
