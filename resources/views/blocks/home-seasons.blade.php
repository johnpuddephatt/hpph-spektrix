        ...
        <div  x-ref="wrapper" class=" swiper-wrapper w-full">
            @foreach ($seasons as $season)
                 <a style="color: {{ $season->color }} !important;"
                     ...
                     class="swiper-slide text-white rounded   group   block relative overflow-hidden">
                    ...
                    @endif
                     ...
                     <p
                         class="type-xs-mono mb-6">
                         {{ $season->short_description }}</p>


<span class="inline-block rounded group-hover:bg-yelow group-hover:text-black border border-yellow text-yellow type-regular px-12 py-3">Info &amp; tickets</span>
