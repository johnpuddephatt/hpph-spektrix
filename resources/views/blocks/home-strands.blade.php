        ...
        <div  x-ref="wrapper" class=" swiper-wrapper w-full">
            @foreach ($strands as $strand)
                 <a style="color: {{ $strand->color }} !important;"
                     ...
                     @endif
                     <p
                         class="hidden lg:block type-xs-mono w-full px-8 max-w-xs lg:px-0 lg:group-hover:opacity-100 lg:opacity-0 transition lg:group-hover:translate-y-1/2 left-1/2 transform -translate-x-1/2 absolute bottom-6 lg:bottom-1/2 mx-auto lg:w-64">
