    ...
    <div class="relative w-full max-w-lg mx-auto">
        <div class="rounded pt-[56%] relative p-12 bg-black bg-opacity-25 backdrop-blur-sm border border-gray-medium">
            ...
            <div
                ...
                Member #{{ $settings['15_25_membership_count'] ?? '001' }}</div>
        </div>
    </div>
</div>

<spektrix-memberships class="relative block mx-auto max-w-xs pb-2" client-name="{{ $settings['spektrix_client_name'] }}"
