            ...
            @if ($layout->event->featuredVideo)
                ...
                @if ($layout->event->featuredVideo->video_conversions)
                    ...
                    <div class="absolute inset-0 -z-10 h-full w-full bg-black opacity-0">
                        <video
                            onplay="(function(e){e.parentNode.classList.remove('opacity-0');e.parentNode.classList.add('opacity-100'); setTimeout((e)=>{ console.log(e); $el.currentTime = 0 },3500)})(this)"
