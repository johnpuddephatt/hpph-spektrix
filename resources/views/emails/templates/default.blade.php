<mjml>
    ...
    <mj-body padding="0">
        <mj-section padding="5px 0 0" full-width="full-width" background-color="#000000" padding="0">
            <mj-text align="center" padding="0" color="#ffffff">
        ...
        <mj-wrapper background-color="#000" padding="0px 0 10px" full-width="full-width">
            <mj-section full-width="full-width" padding="0px 0 0px ">
                ...
                <mj-text font-size="20px" align="center" color="#ffffff" line-height="1.2" font-weight="700">
