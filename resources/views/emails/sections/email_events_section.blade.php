            ...
            <mj-column width="70%">
                <mj-text line-height="1.2" padding="5px 0 5px 15px" font-family="BasisGrotesque" font-weight="700"
                    ...
                    @if ($film->certificate_age_guidance)
                        <span
                            style="line-height: 1; vertical-align: middle; border-radius: 100px; background-color: #333; color: white; padding: 0 4px; font-weight: 400; font-size: 10px; display: inline-block">{{ $film->certificate_age_guidance }}</span>
                    @endif
                </mj-text>
