    ...
    <div
        ...
        @foreach ($images as $image)
            <figure
                ...
                <img src="{{ $image['url'] }}"
                    class="@if (count($images) > 2) h-[32em] w-auto @elseif(count($images) == 2) w-full h-auto lg:max-w-[80vw] lg:h-[calc(100%-3rem)] object-cover @else w-full h-auto @endif block rounded">
