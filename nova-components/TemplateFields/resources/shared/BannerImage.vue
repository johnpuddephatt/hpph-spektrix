<template>
    <media-library-renderless
        ...
        @has-uploads-in-progress-change="
            $emit('has-uploads-in-progress-change', $event)
        "
        v-slot="{
            state,
            getImgProps,
    ...
    >
        ...
        <div
            class="media-library relative text-gray-700"
            :class="[
        ...
        >
            ...
            >
                <div v-for="object in state.media" class="media-library-item">
                    ...
                    <div
                        class="bg-white bg-opacity-50 p-4 rounded absolute bottom-4 right-4 shadow-lg text-xs text-gray-600"
                    >
                        <item-errors
                        ...
                        <template v-else>
                            <slot name="properties" :object="object">
                                ...
                                >
                                    {{
                                        (object.attributes.size / 1024).toFixed(
                                            2
                                        )
                                    }}
                                    KB
            ...
            <div
                v-show="
                    !computedMaxItems || state.media.length < computedMaxItems
                "
...
export default {
    props: {
        thumbnailClasses: { required: false, type: String },
